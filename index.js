...
const researcherAgentTools = toolkit.getTools();

const askNewsTool = new DynamicStructuredTool({
  name: "AskNews",
...
researcherAgentTools.push(askNewsTool)
...
const agentNextState = await researcherAgent.invoke(
